export async function onRequestPost(context: any) {
  ...
  try {
    ...
    // 🔒 TRAVA DE SOBERANIA BRASILEIRA (UTC-3 Absoluto)
    const tz = -3;

    // A IA agora descobre apenas o sol nascente/poente do local. O Timezone não é mais solicitado.
